...
class ListenerAccionPelicula implements ActionListener{
    ...
    public ListenerAccionPelicula(JTextArea JTextAreaResultado,RepositorioDirector RepositorioDirector, RepositorioContenido RepositorioContenido,RepositorioPelicula RepositorioPelicula,ButtonGroup buttonGroupDireccion, JTextField JTextFieldNombre, JTextField JTextFieldDirector, JTextField JTextFieldAnio, JTextArea JTextAreaResumen, JTextField JTextFieldDirectorNacionalidad ) {
            ...
            case "Consultar":
                ...
                Optional<pelicula> Resultado = RepositorioPelicula.findById(contenidoId);
                    if (Resultado.isPresent()) {
                        ...
                        JTextFieldDirector.setText("");
                        JTextFieldAnio.setText("");
                        JTextFieldDirectorNacionalidad.setText("");
                        JTextAreaResumen.setText("");
             ...
             case "Actualizar":
                 ...
                 if (contenidoId != null) {
                     ...
                     if (Resultado.isPresent()) {
                         ...
                         JTextAreaResultado.setText("Se actualizó una pelicula");
