...
public class PanelSeries extends JPanel {
    ...
    private void initComponents() {
        ...
        ListenerAccionSerie ListenerAccionSerie = new ListenerAccionSerie(JTextAreaResultado, 
                repositorioSerie, jRadioButtonConsultar, jRadioButtonActualizar, 
                jRadioButtonInsertar, jRadioButtonEliminar, JTextFieldNombre, JTextFieldEpisodios, 
                JTextFieldTemporadas);
